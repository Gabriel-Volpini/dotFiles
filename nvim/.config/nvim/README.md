...
- configurar LINT
- autocomplete com o tab e selecionar opcoes com C-j e C-k
- criar um toggle do relative line number q funcione
- snippets
  - para testes (unit e integration)
    - it
    - describe
    - akela repeticao do nest
